...
## DATA OVERVIEW 
The dataset comprises daily sales transactions recorded across pharmacies and products, along with supporting information on time, geography, and product hierarchy. It provides a structured view of operations, enabling a clear understanding of sales performance across different locations and product categories.

## GOAL OF THE ANALYSIS 
The goal of the analysis includes the following

- Find how sales and profitability vary across countries, regions, and individual pharmacies
-	Find how different product categories and brands perform in different locations
-	Find how regional performance contributes to overall business results
